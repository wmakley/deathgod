...
(EXIT, COMMAND_EVENT, GAME_STATE_CHANGED, DISPLAY_INITED, MESSAGE,\
 MESSAGE_VIEW_STATE_CHANGED, ANY_KEY, DISPLAY_NEEDS_UPDATE, MESSAGE_FLUSH) = range(9)
...
# command event types
(CE_PLAYER_MOVED, CE_MORE, CE_CONFIRM) = range(3)
...
(QUEUE_EMPTY, QUEUE_NOT_EMPTY) = range(2)
